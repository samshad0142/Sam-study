(async function(){
  ...
  try{
    ...
    if(!cfg.apiKey || !cfg.projectId || !cfg.appId){
      console.warn(
        "Firebase web config is incomplete. Set FIREBASE_API_KEY, FIREBASE_APP_ID and related Render variables."
      );
      return;
    }
  ...
  function friendlyError(e){
    ...
    const map={
      "auth/api-key-not-valid":
        "Firebase API key is invalid. Update the Firebase Web App config in Render Environment Variables.",

      "auth/invalid-api-key":
        "Firebase API key is invalid. Update the Firebase Web App config in Render Environment Variables.",

      "auth/operation-not-allowed":
        "Enable this sign-in method in Firebase Authentication.",

      "auth/unauthorized-domain":
        "Add this Render domain to Firebase Authentication → Settings → Authorized domains.",
